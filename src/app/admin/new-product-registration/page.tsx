    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-white p-4 rounded-lg shadow-md">
              ...
              <select id="registrar-select" value={selectedRegistrarId} onChange={e => setSelectedRegistrarId(e.target.value)} className="w-full p-2 border rounded-md border-gray-300">
          ...
          <div className="bg-white p-4 rounded-lg shadow-md">
              ...
              <select id="supplier-select" value={selectedSupplierId} onChange={e => setSelectedSupplierId(e.target.value)} className="w-full p-2 border rounded-md border-gray-300">
